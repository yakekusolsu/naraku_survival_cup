...
<template>
  <PageHero eyebrow="Shop / Plugin Linked" title="ポイントで戦況を買う。" description="PlayerPoints と Paper Plugin に連動する大会ショップ。自分・自チームへのバフ、他チームへのデバフ、ワールド効果を購入できます。" />
  <section class="section-shell pb-24">
    <div class="glass mb-6 grid gap-4 rounded-3xl p-5 md:grid-cols-[1fr_auto] md:items-center">
      <div>
        ...
        <h2 class="mt-2 text-2xl font-black">購入はサーバー接続後に PlayerPoints 残高から決済</h2>
        <p class="mt-2 leading-7 text-slate-300">
          購入リクエストは REST API 経由でプラグインへ送信され、効果付与、クールダウン、監査ログ、Discord通知まで連動する想定です。
        </p>
      </div>
